...
var VoucherComponent = (function () {
    function VoucherComponent(location) {
    ...
    VoucherComponent.prototype.goBack = function () {
        this.location.back();
    };
    VoucherComponent = __decorate([
        core_1.Component({
            selector: 'voucher-app',
            templateUrl: './app/voucher.component.html',
            styleUrls: ['./app/voucher.component.css']
        }), 
